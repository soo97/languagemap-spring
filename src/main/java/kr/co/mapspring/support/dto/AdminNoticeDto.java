...
public class AdminNoticeDto {
    ...
    public static class RequestCreate {
        ...
        @Schema(description = "이미지 목록", example = "[\"dog.jpg\"]")
        private List<String> noticeImg;
 
        @Schema(description = "링크 목록", example = "[\"https://www.naver.com/\"]")
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    @Schema(description = "공지사항 단건 상세 응답 DTO(관리자)")
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    @Schema(description = "공지사항 리스트 응답 DTO(관리자)")
