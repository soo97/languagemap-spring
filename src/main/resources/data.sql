...
-- MISSION
INSERT INTO mission (mission_title, mission_description, mission_status, scenario_id)
VALUES
('카페 주문하기', '아메리카노를 주문해보세요.', 'READY', 1),
('추천 메뉴 물어보기', '추천 메뉴를 질문해보세요.', 'READY', 2),
('커스터마이징 주문', '샷 추가, 시럽 변경 요청하기', 'READY', 3),
('공항 체크인', '항공권을 제시하고 체크인하기', 'READY', 4),
('수하물 문제 해결', '분실된 짐에 대해 문의하기', 'READY', 5),
('호텔 체크인', '프론트에서 체크인 요청하기', 'READY', 6),
('호텔 컴플레인', '객실 문제에 대해 불만 제기하기', 'READY', 7),
('음식 주문하기', '메뉴를 보고 음식 주문하기', 'READY', 8),
('메뉴 추천 요청', '직원에게 인기 메뉴 물어보기', 'READY', 9),
('상품 찾기', '원하는 물건 위치 물어보기', 'READY', 10),
('환불 요청', '구매한 상품 환불 요청하기', 'READY', 11);
