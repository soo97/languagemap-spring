    ...
    void USER_null_메시지_저장_성공() throws Exception {
        CoachingMessageDto.RequestSaveCoachingMessage request =
                CoachingMessageDto.RequestSaveCoachingMessage.builder()
                        ...
                        .role(CoachingMessageRole.USER)
                        .message(null)
                        .audioUrl("/static/uploads/user-null.wav")
                        .build();
        ...
        setField(savedMessage, "audioUrl", "/static/uploads/user-null.wav");
        ...
        assertThat(response.getAudioUrl()).isEqualTo("/static/uploads/user-null.wav");
    ...
    void USER_빈문자열_메시지_저장_성공() throws Exception {
        CoachingMessageDto.RequestSaveCoachingMessage request =
                CoachingMessageDto.RequestSaveCoachingMessage.builder()
                        ...
                        .role(CoachingMessageRole.USER)
                        .message("")
                        .audioUrl("/static/uploads/user-empty.wav")
                        .build();
        ...
        setField(savedMessage, "audioUrl", "/static/uploads/user-empty.wav");
        ...
        assertThat(response.getAudioUrl()).isEqualTo("/static/uploads/user-empty.wav");
