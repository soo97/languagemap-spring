...
# 프로젝트 실행 방법(Run Project)

## 레포지토리 복제(Clone Repository)

```bash
git clone https://github.com/soo97/languagemap-spring.git
```

---

## Spring Boot 실행(Run Spring Boot)
